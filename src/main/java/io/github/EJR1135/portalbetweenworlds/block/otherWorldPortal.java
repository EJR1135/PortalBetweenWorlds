...
import io.github.EJR1135.portalbetweenworlds.gen.dim.otherWorldDimensions;
import io.github.EJR1135.portalbetweenworlds.gen.dim.otherWorldTravelAgent;
...
public class otherWorldPortal extends TranslucentBlock implements BlockTemplate, CustomPortal, TeleportationManager {
    public static int spr;

    public otherWorldPortal(Identifier identifier) {
    ...
    public void randomDisplayTick(World world, int i, int j, int k, Random random) {
        ...
        for (int l = 0; l < 4; ++l) {
            ...
            world.addParticle("otherWorld_portal", d, d1, d2, d3, d4, d5);
        }
    }

    @Override
    public Identifier getDimension(PlayerEntity player) {
        return otherWorldDimensions.THE_otherWorld;
    }

    public PortalForcer getTravelAgent(PlayerEntity player) {
        return new otherWorldTravelAgent();
    }
}